...
function(downloadSQLiteIfNeeded projectName)
    ...
    add_library("${projectName}" "${${projectName}_AMALGAMATION_SOURCE_DIR}/sqlite3.c")
    target_include_directories("${projectName}" PUBLIC "${${projectName}__AMALGAMATION_SOURCE_DIR}")
endfunction()
