...
[![Travis CI Linux Build Status](https://travis-ci.org/SRombauts/SQLiteCpp.svg?branch=sqlitecpp-2.x)](https://travis-ci.org/SRombauts/SQLiteCpp "Travis CI Linux Build Status")
